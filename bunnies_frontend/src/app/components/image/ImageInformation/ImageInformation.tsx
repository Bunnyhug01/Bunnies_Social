...
export default function ImageInformation({ image, langDictionary } : Props) {
  ...
  return (
    <Box>
      <Box className="flex items-center lg:w-[100%] md:w-[100%] sm:w-[100%] h-[80px] py-4 px-8 sm:px-4 sm:mt-4 lg:mt-0 md:mt-0">

        <Box>
          <Link href={`/${lang}/user/${image.owner}`} style={{ textDecoration: 'none' }}>
